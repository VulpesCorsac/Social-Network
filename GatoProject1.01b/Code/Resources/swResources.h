...
const indx_t BALLS_PA = 2;

const float SW_E = 2.718281;

const colr_t PHONE_R = 0.2;
...
const colr_t ARC_R   = 0.2;
const colr_t ARC_G   = 0.7;
const colr_t ARC_B   = 0.7;

const colr_t BALL_R  = 0.5;
const colr_t BALL_G  = 0.8;
const colr_t BALL_B  = 0.5;

const colr_t NODE_R  = 1.0;
const colr_t NODE_G  = 0.0;
const colr_t NODE_B  = 0.0;

const pos_t  NODE_RAD     =   0.1;//0.7;
const pos_t  BALL_RAD     =   0.05;	
const pos_t  NODE_KOEF    =   0.65;
const pos_t  SHIFT_SCREEN =   0.5;
const pos_t  NODE_Z_COORD = - 0.1;
const pos_t  INFO_Z_COORD = - 0.2;
const pos_t  TEXT_Z_COORD = - 0.3;
const pos_t  GRAPH_SQR    =   NODE_RAD * 2.4;
const pos_t  MIN_LEN_SQR  =   NODE_RAD * NODE_RAD * 10;//25;
...
const int BIG_NUM_FOR_RAND = 30000;
